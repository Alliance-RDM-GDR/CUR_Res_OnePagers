...
🌍 <a href="https://alliance-rdm-gdr.github.io/CUR_Res_OnePagers/RDM_TreeGen_fr.html" target="_blank">🇫🇷 Version Française</a>
</div>
:::
...
Double-click on the **Description** column to annotate/describe any file or folder. Descriptions are automatically saved in a hidden `.descriptions.json` file.
...
TreeGen was developed and is maintained by the curation team of the [Digital Research Alliance of Canada](https://alliancecan.ca/en).
